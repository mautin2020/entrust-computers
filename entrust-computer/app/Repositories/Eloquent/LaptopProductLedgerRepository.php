...
class LaptopProductLedgerRepository extends BaseRepository implements ILaptopProductLedger 
{

    public function model()
    {
        return LaptopProductLedger::class;
    }
        ...
        public function getByProductLedger(Request $request)
            {
                ...
                if($request->productCode){
                    $query->where(function($productCode) use($request){
                        $productCode->where('product_code', 'like', '%'.$request->productCode.'%');
                    });
                }
